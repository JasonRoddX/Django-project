...
for root, dirs, files in os.walk("/var/www/clients/client1/web1/web/data/SinDetectar"):
    if re.search(r'\d\d\d\d', root.split("/")[-1]):
        ...
        if not agosto == septiembre == octubre == noviembre == diciembre == enero == febrero == otros == 0:
            videos = 0                    
            ...
            print(servidor, camara, julio, agosto, septiembre, octubre, noviembre, diciembre, enero, febrero, otros, videos)
